...
module.exports = function(args) {
  ...
  if (!args.bucket) {
    ...
    help += '    type: s3\n';
    help += '    bucket: <bucket>\n';
    help += '    [aws_key]: <aws_key>        # Optional, if provided as environment variable or in ~/.aws/credentials file\n';
    help += '    [aws_secret]: <aws_secret>  # Optional, if provided as environment variable or in ~/.aws/credentials file\n';
  ...
  if (args.aws_key && args.aws_secret) {
    options.accessKeyId = args.aws_key;
    options.secretAccessKey = args.aws_secret;
  }
